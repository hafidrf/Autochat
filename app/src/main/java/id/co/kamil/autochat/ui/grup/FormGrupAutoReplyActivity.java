...
import static id.co.kamil.autochat.utils.API.URL_POST_CREATE_GROUP_AUTO_REPLY;
import static id.co.kamil.autochat.utils.API.URL_POST_EDIT_GROUP_AUTO_REPLY;
...
public class FormGrupAutoReplyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_grup_auto_reply);
                                ...
                                new AlertDialog.Builder(FormGrupAutoReplyActivity.this)
                                        ...
                                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                session.clearData();
                                                startActivity(new Intent(FormGrupAutoReplyActivity.this, LoginActivity.class));
                                                finish();
                                            }
                                        })
                                        .show();
