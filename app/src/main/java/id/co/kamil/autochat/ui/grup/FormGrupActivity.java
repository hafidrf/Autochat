...
public class FormGrupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_grup);
        ...
        if (tipeForm.equals("add")){
            ...
            try {
                ...
                customers = new JSONArray(data.getString("customers"));
                                ...
                                new AlertDialog.Builder(FormGrupActivity.this)
                                        ...
                                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                session.clearData();
                                                startActivity(new Intent(FormGrupActivity.this, LoginActivity.class));
                                                finish();
                                            }
                                        })
                                        .show();
