...
public class AdapterTemplateDictionary extends BaseAdapter {
    private final String TAG = "AdapterTemplatePromosi";
    public List<ItemTemplateDictionary> listData;
    ...
    public AdapterTemplateDictionary(List<ItemTemplateDictionary> apps, Context context) {
        this.listData = apps;
        this.context = context;
        arraylist = new ArrayList<ItemTemplateDictionary>();
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            viewHolder.txtKeyword = (TextView) rowView.findViewById(R.id.txtKeyword);
            viewHolder.chk1 = (CheckBox) rowView.findViewById(R.id.checkbox);
            viewHolder.txtNilai = (TextView) rowView.findViewById(R.id.txtNilai);
        ...
        viewHolder.txtNilai.setText(nilai);
