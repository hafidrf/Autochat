...
public class FormTemplateNotifActivity extends AppCompatActivity {

    private static final String TAG = "FormTempNotifActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_template_notif);
                                ...
                                new AlertDialog.Builder(FormTemplateNotifActivity.this)
                                        ...
                                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                session.clearData();
                                                startActivity(new Intent(FormTemplateNotifActivity.this, LoginActivity.class));
                                                finish();
                                            }
                                        })
                                        .show();
