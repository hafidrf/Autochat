...
import id.co.kamil.autochat.autoreply.models.NotificationIds;

import static id.co.kamil.autochat.autoreply.MyNotifiService.other_action;
        ...
        for (int i = 0; i < NotificationCompat.getActionCount(n); i++) {
            ...
            if (action.getRemoteInputs() != null) {
                for (int x = 0; x < action.getRemoteInputs().length; x++) {
                    ...
                    other_action = other_action + remoteInput.getResultKey() + ";";
