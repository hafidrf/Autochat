...
public class AdapterFollowup extends BaseAdapter {
    private final String TAG = "AdapterGrup";
    public List<ItemFollowup> dataFollowup;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        final ItemFollowup item = dataFollowup.get(position);
    ...
    public void filter(String charText) {
        ...
        if (charText.length() == 0) {
            ...
            for (ItemFollowup postDetail : arraylist) {
