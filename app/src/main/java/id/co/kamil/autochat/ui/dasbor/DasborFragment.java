...
public class DasborFragment extends Fragment  implements  ViewTreeObserver.OnScrollChangedListener {
    ...
    private LinearLayout btnPengaturan;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switchEnableForegroundService = (Switch) view.findViewById(R.id.switchEnableForegroundService);
        ...
        btnShare2 = (LinearLayout) view.findViewById(R.id.btnShare2);
        ...
        btnAffiliasi = (LinearLayout) view.findViewById(R.id.btnAffiliasi);
        ...
        btnAffiliasi2 = (LinearLayout) view.findViewById(R.id.btnAffiliasi2);
        btnAffiliasi2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getContext(), AffiliasiActivity.class));
            }
        ...
        switchEnableForegroundService.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                Intent pushNotification = new Intent(MAIN_RECEIVER);
                pushNotification.putExtra("action", isChecked ? "enableForegroundService" : "disableForegroundService");
                LocalBroadcastManager.getInstance(getContext()).sendBroadcast(pushNotification);
            }
        });
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        if (url_upgrade == null || url_upgrade.equals(null) || url_upgrade.equals("null")) {
                            btnUpgrade2.setVisibility(View.GONE);
                        } else {
                            _URL_UPGRADE = url_upgrade;
                            btnUpgrade2.setVisibility(View.VISIBLE);
                        }
                        ...
                        dataDashboard.add(new ItemDashboard("Pesan Pending", message_pending, "tosca"));
                        dataDashboard.add(new ItemDashboard("Schedule Message", schedule_active, "orange"));
                        dataDashboard.add(new ItemDashboard("Pesan Terkirim", message_sent, "green"));
