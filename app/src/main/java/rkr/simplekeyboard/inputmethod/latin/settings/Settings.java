...
public final class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String PREF_HIDE_LANGUAGE_SWITCH_KEY =
            "wabot_pref_hide_language_switch_key";
    public static final String PREF_CUSTOM_INPUT_STYLES = "custom_input_styles";
    public static final String PREF_VIBRATION_DURATION_SETTINGS =
            "wabot_pref_vibration_duration_settings";
    public static final String PREF_KEYPRESS_SOUND_VOLUME = "wabot_pref_keypress_sound_volume";
    public static final String PREF_KEY_LONGPRESS_TIMEOUT = "wabot_pref_key_longpress_timeout";
    public static final String PREF_KEYBOARD_HEIGHT = "wabot_pref_keyboard_height";
    public static final String PREF_KEYBOARD_COLOR = "wabot_pref_keyboard_color";
    public static final String PREF_HIDE_SPECIAL_CHARS = "wabot_pref_hide_special_chars";
    public static final String PREF_SHOW_NUMBER_ROW = "wabot_pref_show_number_row";
    public static final String PREF_SPACE_SWIPE = "wabot_pref_space_swipe";
    public static final String PREF_DELETE_SWIPE = "wabot_pref_delete_swipe";
    public static final String PREF_MATCHING_NAVBAR_COLOR = "wabot_pref_matching_navbar_color";
    ...
    public static boolean readShowsLanguageSwitchKey(final SharedPreferences prefs) {
        return !prefs.getBoolean(PREF_HIDE_LANGUAGE_SWITCH_KEY, true);
    }
